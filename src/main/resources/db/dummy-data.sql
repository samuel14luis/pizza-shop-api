...
TRUNCATE `htl_pizza_bd`.`order_item`;
TRUNCATE `htl_pizza_bd`.`pizza_order`;
TRUNCATE `htl_pizza_bd`.`customer`;
TRUNCATE `htl_pizza_bd`.`pizza`;
SET FOREIGN_KEY_CHECKS = 1;

-- INSERT CUSTOMERS
INSERT INTO `htl_pizza_bd`.`customer` (`id_customer`, `name`, `address`, `email`, `phone_number`)
VALUES
...
-- INSERT PIZZAS
INSERT INTO `htl_pizza_bd`.`pizza` (`id_pizza`, `name`, `description`, `price`, `vegetarian`, `vegan`, `available`)
VALUES
...
-- INSERT ORDERS
INSERT INTO `htl_pizza_bd`.`pizza_order` (`id_order`, `id_customer`, `date`, `total`, `method`, `additional_notes`)
VALUES
...
-- INSERT ORDER ITEMS
INSERT INTO `htl_pizza_bd`.`order_item` (`id_order`, `id_item`, `id_pizza`, `quantity`, `price`)
VALUES
(1, 1, 1, 1, 23.0),
(1, 2, 4, 1, 19.95),
(2, 1, 2, 1, 18.5),
